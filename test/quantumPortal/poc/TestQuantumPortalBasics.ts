...
//     let remoteBalance = Wei.to(
//       (
//         await ctx.chain2.poc.remoteBalanceOf(
//           ctx.chain1.chainId,
//           ctx.chain1.token.address,
//           tx.remoteContract.toString()
//         )
//       ).toString()
//     );
