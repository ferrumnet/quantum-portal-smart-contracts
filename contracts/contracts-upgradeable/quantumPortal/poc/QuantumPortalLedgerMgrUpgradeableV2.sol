...
*/
contract QuantumPortalLedgerMgrUpgradeableV2 is Initializable, UUPSUpgradeable, WithAdminUpgradeable, WithGatewayUpgradeable, IVersioned {
    ...
    string public constant override VERSION = "000.002";
    ...
    function testVar() public view returns (uint256) {
        return _getQuantumPortalLedgerMgrStorageV001().testVar;
    }
...
contract QuantumPortalLedgerMgrImplUpgradeableV2 is QuantumPortalLedgerMgrUpgradeableV2 {
    constructor() QuantumPortalLedgerMgrUpgradeableV2(0) {}
}
